"""RT-DETR runner -- Real-Time Detection Transformer using Ultralytics.

Same Ultralytics API as YOLO, but uses transformer architecture.
"""
...
def run(model, input_path: str, output_dir: str, options: dict):
    """Run RT-DETR inference. Yields progress dicts."""
    import cv2
