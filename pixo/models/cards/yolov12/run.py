"""YOLOv12 runner -- attention-based object detection using Ultralytics.

Same API as YOLOv8/v11 -- Ultralytics handles all YOLO versions transparently.
"""
...
def run(model, input_path: str, output_dir: str, options: dict):
    """Run YOLO12 inference. Yields progress dicts."""
    import cv2
